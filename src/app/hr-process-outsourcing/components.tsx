  ...
  <section className="relative h-auto min-h-[50vh] py-12 flex items-center justify-center">
    ...
    <div className="relative z-10 container mx-auto px-4">
      ...
      >
        ...
        >
          Transform HR efficiency with comprehensive process outsourcing. Focus on strategy while we handle operations with precision and compliance.
        </motion.p>
...
export const CTASection = () => (
  <Section className={STYLES.gradientBg}>
    ...
    >
      ...
      >
        Discover how our comprehensive HR process outsourcing can streamline operations, reduce costs, and enhance efficiency.
      </motion.p>
      <motion.div variants={ANIMATION_VARIANTS.item}>
        <Link href="/contact">
