  ...
  <section className="relative h-auto min-h-[50vh] py-12 flex items-center justify-center">
    ...
    <div className="relative z-10 container mx-auto px-4">
      ...
      >
        ...
        >
          Accurate, timely, and compliant payroll processing that eliminates administrative burden. Focus on your business while we ensure perfect payroll execution.
        </motion.p>
...
export const CTASection = () => (
  <Section className={STYLES.gradientBg}>
    ...
    >
      ...
      >
        Experience the peace of mind that comes with accurate, compliant, and efficient payroll management.
      </motion.p>
      <motion.div variants={ANIMATION_VARIANTS.item}>
        <Link href="/contact">
