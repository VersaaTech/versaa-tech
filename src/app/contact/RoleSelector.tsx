                ...
                <div className="flex space-x-6">
                    <div className="flex items-center">
                        <input
                            ...
                            className="mr-3 w-4 h-4 text-blue-600 focus:ring-blue-500 accent-blue-600"
                        />
                        <label htmlFor="jobseeker" className="text-muted-foreground cursor-pointer font-medium">
                            Job Seeker
                        </label>
                    </div>
                    <div className="flex items-center">
                        <input
                            ...
                            className="mr-3 w-4 h-4 text-blue-600 focus:ring-blue-500 accent-blue-600"
                        />
                        <label htmlFor="employer" className="text-muted-foreground cursor-pointer font-medium">
                            Employer
                        </label>
                    </div>
                </div>
