  ...
  <section className="relative h-auto min-h-[50vh] py-12 flex items-center justify-center">
    ...
    <div className="relative z-10 container mx-auto px-4">
      ...
      >
        ...
        >
          Data-driven insights that position your organization competitively. Our comprehensive benchmarking delivers strategic intelligence for informed decision-making.
        </motion.p>
...
export const CTASection = () => (
  <Section className={STYLES.gradientBg}>
    ...
    >
      ...
      >
        Discover how our industry benchmarking insights can drive strategic decision-making and competitive advantage for your organization.
      </motion.p>
      <motion.div variants={ANIMATION_VARIANTS.item}>
        <Link href="/contact">
